...
c_1:
	...
	.quad	a_1
	.text
	.globl	YOUR__PROGRAM__NAME
	.type	YOUR__PROGRAM__NAME, @function
YOUR__PROGRAM__NAME:
.LFB22:
	.cfi_startproc
	pushq	%rbp
	...
	movl	$0, %edi
	call	YOUR__PROGRAM__NAME_
	popq	%rbp
	.cfi_def_cfa 7, 8
	ret
	.cfi_endproc
.LFE22:
	.size	YOUR__PROGRAM__NAME, .-YOUR__PROGRAM__NAME
	.section	.rodata
.LC1:
	.string	"1.1"
.LC2:
	.string	"test.cbl"
.LC3:
	.string	"YOUR-PROGRAM-NAME"
	.text
	.type	YOUR__PROGRAM__NAME_, @function
YOUR__PROGRAM__NAME_:
.LFB23:
	.cfi_startproc
	pushq	%rbp
	.cfi_def_cfa_offset 16
...
.L8:
	...
	testq	%rax, %rax
	je	.L9
	movl	$YOUR__PROGRAM__NAME_, %edx
	movl	$YOUR__PROGRAM__NAME, %esi
	movl	$.LC3, %edi
	call	cob_set_cancel
.L9:
	movl	$b_1, %eax
...
.L12:
	...
	.cfi_endproc
.LFE23:
	.size	YOUR__PROGRAM__NAME_, .-YOUR__PROGRAM__NAME_
